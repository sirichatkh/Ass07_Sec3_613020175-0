...
class MainActivity : AppCompatActivity() {
    ...
    fun employeeData(){
        employeesList.add(Employee("Danny", "Male", "danny@kku.ac.th", 30000))
        employeesList.add(Employee("Sara", "Female", "sara@kku.ac.th", 34000))
    ...
    fun addEmployee(view: View) {
        ...
        myAlertDialog.btnAdd.setOnClickListener(){
            ...
            employeesList.add(Employee(name, gender, mail, salary))
